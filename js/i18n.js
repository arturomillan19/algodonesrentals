const TRANSLATIONS = {
    es: {
        ...
        // MODAL
        "modal.eyebrow": "Algodones Rentals · 10% en línea",
        "modal.title": "Reserva tus<br><em>jetskis</em>",
        "modal.sub": "Elige cuántos y de qué modelo. Confirmamos disponibilidad por WhatsApp; al recibir dejas ID y firmas contrato.",
        "modal.nombre": "Nombre",
        "modal.duracion": "Duración (para todos)",
        "modal.dur.0": "1 hora",
        "modal.dur.1": "Media hora",
        "modal.fecha": "Fecha",
        "modal.notas": "Notas (opcional)",
        "modal.notas.ph": "Ej. tiempos distintos por unidad, dudas…",
        "modal.submit": "Enviar por WhatsApp",
        "modal.legal": "10% de descuento en línea · Confirmamos disponibilidad · Pago en remolque o transferencia · ID + contrato al recibir",

        // CART
        "cart.choose": "Elige tus jetskis",
        "cart.max1": "máx 1",
        "cart.max3": "máx 3",
        "cart.subtotal": "Subtotal",
        "cart.discount": "Descuento en línea (10%)",
        "cart.total": "Total estimado",
        "cart.note": "Precio estimado. Confirmamos disponibilidad y total exacto por WhatsApp.",
        ...
        "wa.discount": "Descuento en línea (10%)",
        "wa.total": "Total estimado",
        "wa.notas": "Notas",
        "wa.online": "Reservé en línea desde la página → 10% de descuento.",
    ...
    en: {
        ...
        // MODAL
        "modal.eyebrow": "Algodones Rentals · 10% online",
        "modal.title": "Book your<br><em>jetskis</em>",
        "modal.sub": "Pick how many and which models. We confirm availability on WhatsApp; on pickup you leave an ID and sign a contract.",
        "modal.nombre": "Name",
        "modal.duracion": "Duration (for all)",
        "modal.dur.0": "1 hour",
        "modal.dur.1": "Half hour",
        "modal.fecha": "Date",
        "modal.notas": "Notes (optional)",
        "modal.notas.ph": "E.g. different times per unit, questions…",
        "modal.submit": "Send via WhatsApp",
        "modal.legal": "10% off online · We confirm availability · Pay at trailer or by transfer · ID + contract on pickup",

        // CART
        "cart.choose": "Choose your jetskis",
        "cart.max1": "max 1",
        "cart.max3": "max 3",
        "cart.subtotal": "Subtotal",
        "cart.discount": "Online discount (10%)",
        "cart.total": "Estimated total",
        "cart.note": "Estimated price. We confirm availability and the exact total on WhatsApp.",
        ...
        "wa.jetskis": "Jetskis",
        "wa.subtotal": "Subtotal",
        "wa.discount": "Online discount (10%)",
        "wa.total": "Estimated total",
        "wa.notas": "Notes",
        "wa.online": "I booked online from the page → 10% discount.",
