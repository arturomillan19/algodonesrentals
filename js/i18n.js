const TRANSLATIONS = {
    es: {
        ...
        "modal.sub": "Agrega cada vehículo con su modelo, duración y hora. Confirmamos disponibilidad por WhatsApp; al recibir dejas ID y firmas contrato.",
        "modal.nombre": "Nombre",
        "modal.dur.0": "1 hora",
        "modal.dur.1": "Media hora",
        "modal.fecha": "Fecha (del día)",
        "modal.notas": "Notas (opcional)",
        "modal.notas.ph": "Cualquier detalle o duda…",
    ...
    en: {
        ...
        "modal.sub": "Add each vehicle with its own model, duration and time. We confirm availability on WhatsApp; on pickup you leave an ID and sign a contract.",
        "modal.nombre": "Name",
        "modal.dur.0": "1 hour",
        "modal.dur.1": "Half hour",
        "modal.fecha": "Date",
        "modal.notas": "Notes (optional)",
        "modal.notas.ph": "Any detail or question…",
